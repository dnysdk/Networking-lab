...
public class Simulation {
	...
	public static void main(String[] args) {
		...
		for(int i = 1;i<=9;i++){
			Source s = new Source(40000,filesize,size,1,i,i);
			s.sendfile(s);
			...
			double lth1 = ((double)s.countSend1/s.endtime1);
			double lth2 = ((double)s.countSend2/s.endtime2);
			System.out.println((double)i+"   "+lth1+ " " +lth2);  
